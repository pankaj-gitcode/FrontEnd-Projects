    ...
    return(<>
        <div className='w-full py-16 px-4'>
            ...
            <div className='w-[90%] mx-auto grid md:grid-cols-2'>
                <img src={twoPhonesImg.url} alt="" className='w-[550px] mx-auto hover:-rotate-6 drop-shadow-2xl'/>
                                {/* ---------- DETAILS:FLEX ----------- */}
                <div className='flex flex-col justify-center items-start ml-4'>
                    ...
                    <button className='bg-[#000] text-green-500 rounded-md active:scale-95 active:bg-green-500 active:text-black active:font-semibold hover:shadow-[2px_2px_8px_2px_rgba(0,0,0,0.5)] '>Get Started</button>
                </div>
            </div>
